...
class ActivitiesApi {
  ...
  Future<Response<ActivityPaging>> listActivitiesForPerson(
    String personId, {
    int skipCount,
    int maxItems,
    String who,
    ...
    final String _path = '/people/{personId}/activities'.replaceAll('{' r'personId' '}', personId.toString());
    ...
    queryParams[r'who'] = who;
    queryParams[r'siteId'] = siteId;
    ...
    return _dio
      ...
      onReceiveProgress: onReceiveProgress,
        ...
        .then((response) {
      final serializer = _serializers.serializerForType(ActivityPaging) as Serializer<ActivityPaging>;
      final data = _serializers.deserializeWith<ActivityPaging>(
        serializer,
        response.data is String ? jsonDecode(response.data as String) : response.data,
      );

      return Response<ActivityPaging>(
        data: data,
