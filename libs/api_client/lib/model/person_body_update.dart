...
part 'person_body_update.g.dart';

abstract class PersonBodyUpdate implements Built<PersonBodyUpdate, PersonBodyUpdateBuilder> {
  @nullable
  ...
  static void _initializeBuilder(PersonBodyUpdateBuilder b) => b;

  factory PersonBodyUpdate([void updates(PersonBodyUpdateBuilder b)]) = _$PersonBodyUpdate;
  static Serializer<PersonBodyUpdate> get serializer => _$personBodyUpdateSerializer;
}
