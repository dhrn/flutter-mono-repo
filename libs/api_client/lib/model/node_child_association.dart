...
part 'node_child_association.g.dart';

abstract class NodeChildAssociation implements Built<NodeChildAssociation, NodeChildAssociationBuilder> {
  @nullable
  ...
  NodeChildAssociation._();

  static void _initializeBuilder(NodeChildAssociationBuilder b) => b..isLocked = false;

  factory NodeChildAssociation([void updates(NodeChildAssociationBuilder b)]) = _$NodeChildAssociation;
  static Serializer<NodeChildAssociation> get serializer => _$nodeChildAssociationSerializer;
}
