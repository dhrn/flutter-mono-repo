...
// tests for DeletedNode
void main() {
  final instance = DeletedNode();
  ...
  group(DeletedNode, () {
    ...
    // bool isLocked (default value: false)
    ...
    // bool isLink
    test('to test the property `isLink`', () async {
      // TODO
    });
    ...
    test('to test the property `archivedByUser`', () async {
      // TODO
    });
